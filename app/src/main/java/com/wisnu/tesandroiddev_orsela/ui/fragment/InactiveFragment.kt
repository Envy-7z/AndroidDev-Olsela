...
import com.wisnu.tesandroiddev_orsela.ui.adapter.InactiveAdapter
...
class InactiveFragment : Fragment() {
    ...
    private lateinit var mainAdapter: InactiveAdapter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        mainAdapter = InactiveAdapter(requireContext()) {
    ...
    private fun observeNotes() {
        Coroutines.main {
            viewModel.getInActive().observe(viewLifecycleOwner, {
