...
import com.wisnu.tesandroiddev_orsela.ui.adapter.ActiveAdapter
...
class ActiveFragment : Fragment() {
    ...
    private lateinit var mainAdapter: ActiveAdapter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        mainAdapter = ActiveAdapter(requireContext()) {
    ...
    private fun observeNotes() {
        Coroutines.main {
            viewModel.getActive().observe(viewLifecycleOwner, {
